public class shiyan6_2_3 {
    public static void main(String[] args) {
        ...
        System.out.println("StringBuilder对象的默认空间大小为：" + s1.capacity());
        StringBuilder s2 = new StringBuilder("abcd1234");
        System.out.println("当前字符串为：" + s2.toString() + ",容量为：" + s2.capacity() + ",长度为：" + s2.length());
        System.out.println("s2.delete(3,6) = " + s2.delete(3, 6).toString());   //左闭右开区间
        ...
        System.out.print("当前字符串：" + s2.toString() + ",容量为：" + s2.capacity());
